        ...
        try:
            ...
            if not pdf_files:
                ...
                if stdout_content and stdout_content.strip():
                    ...
                    # If no PDF and no stdout, check for script errors
                    if result.returncode != 0:
                        return jsonify({'error': f"Execution failed:\n{result.stderr}"}), 400
                    return jsonify({'error': 'No PDF file was generated by the script and no output was printed to stdout. Ensure your code saves a PDF (e.g., output("file.pdf")) or prints content.'}), 400
